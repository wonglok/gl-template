...
// const lookUp = (parent, key) => {
//   if (parent[key]) {
//     return parent[key]
//   } else {
//     const gradParent = parent.$parent
//     if (gradParent) {
...
export default {
  ...
  computed: {
    ...
    right () {
      var val = 0
      try {
        val = Parser.evaluate(`rect.width * 0.5 - scaleX * width * 0.5`, this)
      } catch (e) {
        console.log(e)
      }
      return val
    ...
    top () {
      var val = 0
      try {
        val = Parser.evaluate(`rect.height * 0.5 + scaleY * height * -0.5`, this)
      } catch (e) {
        console.log(e)
      }
      return val
    ...
    bottom () {
      var val = 0
      try {
        val = Parser.evaluate(`-rect.height * 0.5 + scaleY * height * 1`, this)
      } catch (e) {
        console.log(e)
      }
      return val
